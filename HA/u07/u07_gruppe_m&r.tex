...
\end{lstlisting}
Wie auch in a) lassen sich hier die wiederholten \texttt{find(B[x,y])}-Operationen wegoptimieren, indem der Ergebnisrepräsentant der vorhergegangenen Union-Operation gespeichert wird. Daher hat die Funktion im Schlimmstfall $4$ Union- und Find-Operationen.
\item
\end{enumerate}
\end{document}